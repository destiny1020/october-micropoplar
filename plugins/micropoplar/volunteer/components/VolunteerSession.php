...
class VolunteerSession extends ComponentBase
{
    const ALLOW_ALL = 'all';
    ...
    {
        return [
            'name'        => 'micropoplar.volunteer::component.vs.session',
            'description' => 'micropoplar.volunteer::component.vs.session_desc'
        ];
    }
